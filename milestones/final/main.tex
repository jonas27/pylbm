...
Finally, I compare the analystical solution to the analytical solution at $t=100,000$.
\begin{figure}[ht]
\centering
\resizebox{0.7\columnwidth}{!}{\large\input{img/m5-1-num-theo.pgf}}
\caption[Poiseuille numerical vs analytical]{Poiseuille velocities comparing the numerical (blue) and analytical (red) solution at $t=100,000$ and $\frac{L_{x}}{2}$.}
