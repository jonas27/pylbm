...
This effect is becomes more pronounced over time as shown in figure
...
I initially wanted to only include the good theoretical results, but decided to include the original results and the update.
I found it interesting that the correctness of the results would be influenced by the collision frequency and the dimensions of the physical space. 
