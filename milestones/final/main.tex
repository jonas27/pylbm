...
The results are shown in figure \ref{fig:use}.

The two left grids visualize the velocities with \textit{imshow} at $t=50$ and $t=100$ while the last two grids . 
At 
The flow in the correct direction and the effects of the reflective boundaries are clearly visible, at the bottom and at the top of the pipe the arrows are not flowing parallel to the boundaries. 
In the 
