...
The reason for the significant divergence is relative low physical space. Increasing the physical/euclidean space to a $300\times300$ grid alivates the issue as shown in figure \
\begin{figure}[ht]
\centering
\resizebox{0.8\columnwidth}{!}{\large\input{img/m3-3-kinematic-viscocity-scaling.pgf}}
% \vspace*{-10mm}
