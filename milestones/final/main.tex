...
Plotting the normalized maximum velocity values along the y dimension and time on the x axis is shown in figure \ref{fig:m3-2-norm-vel}.
\begin{figure}[ht]
\centering
\resizebox{\columnwidth}{!}{\large\input{img/m3_2-shear-wave-decay.pgf}}
\vspace*{-10mm}
...
\end{figure}
It illustrates that the higher the collision frequency the faster the system converges towards an equilibrium state.
