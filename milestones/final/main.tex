...
To achieve this ghost cells are added around each splitted up section of the grid. 
Basically, an additional row or columns of nodes are added to the grid called dry nodes. 
These nodes are not part of the actual experiment but are solely used for computational purposes.
...
\centering
\textbf{\large a)} \\
\resizebox{0.8\columnwidth}{!}{\large\input{img/m7.pgf}}
\vspace*{2mm}

\textbf{\large b)} \\
\resizebox{0.8\columnwidth}{!}{\large\input{img/m7-mlups.pgf}}
