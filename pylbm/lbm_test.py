...
def test_walls_bounce():
    # TODO: better testing needed. Not sure if correct.
    eps = 0.0001
    r_mean = 0.5
    u_mean = 0.5
    i_dim, j_dim = 5, 4
    walls = lbm.make_walls(i_dim=i_dim, j_dim=j_dim, up=True, down=True, left=True, right=True)
    ...
    f_cij = lbm.apply_walls(f_cij=f_cij, f_cij_old=f_cij_old, walls=walls)
